# -*- coding: utf-8 -*-
#
# pytest-caprng documentation build configuration file, created by
...
project = u'pytest-caprng'
copyright = u'2015, John Bjorn Nelson'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-caprng Documentation',
     [author], 1)
]
